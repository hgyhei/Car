...
// 设置颜色
#define GYColor(r, g, b) [UIColor colorWithRed:(r)/255.0f green:(g)/255.0f blue:(b)/255.0f alpha:1.0f]
#define GYAColor(r, g, b, a) [UIColor colorWithRed:(r)/255.0f green:(g)/255.0f blue:(b)/255.0f alpha:(a)]
...
#define kTitlesNormalColor GYColor(45, 48, 53)
#define kTitleSelectedColor gyColor(63, 169, 213)
@interface CarConst : NSObject
