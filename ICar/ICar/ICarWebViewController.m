...
@interface ICarWebViewController ()<UIWebViewDelegate, UIGestureRecognizerDelegate>

@end

@implementation ICarWebViewController
- (instancetype)init {
    self = [super init];
    if (self) {
...
- (void)initWebView {
    ...
    self.navigationItem.leftBarButtonItem = [UIBarButtonItem itemWithTarget:self action:@selector(backToLatesetView) image:@"nav_fanhui" highImage:@"nav_fanhui"];
    self.navigationItem.rightBarButtonItem = [UIBarButtonItem itemWithTarget:self action:@selector(moreButtonClick) image:@"nav_fanhui" highImage:@"nav_fanhui"];
